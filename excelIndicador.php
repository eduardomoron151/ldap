...
<body>
    <div class="container">
        ...
        <main class="main">
            <div class="contenido">
                <h3>Llenado masivo excel por Indicador</h3>
                ...
                <section class="section-excel">
                    <div class="card1-excel">
                        ...
                        <ol>
                            ...
                            <li>Llene el formato solo en la columna de <span class="text-alerta">indicador</span></li>
                    ...
                    <div class="card2-excel">
                        <h4>Formulario</h4>
                        <form  enctype="multipart/form-data" action="generarExcelIndicador.php" method="POST">
